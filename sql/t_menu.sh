...
create table $db.$table_name (
  ...
  F_parent              varchar(64)  COLLATE utf8mb4_unicode_ci    NOT NULL DEFAULT '0' COMMENT '父级菜单 0-否 1-是',
  F_is_link             varchar(1)   COLLATE utf8mb4_unicode_ci    NOT NULL DEFAULT '0' COMMENT '是否外链 0-否 1-是',
