...
| F_parent_permission_code|varchar(64)||父权限代码||
...
| F_is_admin|tinyint(1)||是否是管理员 enum:0,no,否#1,yes,是|0|
| F_status|tinyint(1)||角色状态 enum:0,ensure,待审核#1,normal,正常#2,stop,禁用|0|
| F_deleted|tinyint(1)||删除标记 enum:0,no,否#1,yes,是|0|
| F_operator|varchar(32)||操作员||
| F_create_time|bigint||创建时间戳 单位秒|0|
| F_modify_time|bigint||更新时间戳 单位秒|0|
